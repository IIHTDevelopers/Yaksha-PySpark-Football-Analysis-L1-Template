...
class FunctionalTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.expected_results = {
            ...
            "player_with_least_matches": "Paul Pogba",
            "player_with_most_matches": "Luka Modric"
        }
    ...
    def test_player_with_least_matches(self):
        try:
            result = get_player_with_least_matches(df)
            if result == self.expected_results["player_with_least_matches"]:
                self.test_obj.yakshaAssert("TestPlayerWithLeastMatches", True, "functional")
                print("TestPlayerWithLeastMatches = Passed")
            else:
                self.test_obj.yakshaAssert("TestPlayerWithLeastMatches", False, "functional")
                print("TestPlayerWithLeastMatches = Failed")
        except Exception as e:
            self.test_obj.yakshaAssert("TestPlayerWithLeastMatches", False, "functional")
            print("TestPlayerWithLeastMatches = Failed")

    def test_player_with_most_matches(self):
        try:
            result = get_player_with_most_matches(df)
            if result == self.expected_results["player_with_most_matches"]:
                self.test_obj.yakshaAssert("TestPlayerWithMostMatches", True, "functional")
                print("TestPlayerWithMostMatches = Passed")
            else:
                self.test_obj.yakshaAssert("TestPlayerWithMostMatches", False, "functional")
                print("TestPlayerWithMostMatches = Failed")
        except Exception as e:
            self.test_obj.yakshaAssert("TestPlayerWithMostMatches", False, "functional")
            print("TestPlayerWithMostMatches = Failed")
