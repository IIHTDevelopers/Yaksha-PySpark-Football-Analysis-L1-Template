...
# Function 7: Get the player with the least matches played
def get_player_with_least_matches(df):
    return df.orderBy(F.asc('matches_played')).limit(1).collect()[0]['player_name']

# Function 8: Get the player with the most matches played
def get_player_with_most_matches(df):
    return df.orderBy(F.desc('matches_played')).limit(1).collect()[0]['player_name']
...
print("Player with Least Matches Played:", get_player_with_least_matches(df))
print("Player with Most Matches Played:", get_player_with_most_matches(df))
